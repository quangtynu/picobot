...
func TestOllamaFunctionCallParsing(t *testing.T) {
	// Fake Ollama server returning tool_calls response
		        ...
		        "tool_calls": [
		          {
		            ...
		            "function": {
		              "name": "message",
		              "arguments": "{\"content\": \"From ollama function\"}"
		            }
		          }
		        ]
		      }
	...
	if resp.ToolCalls[0].Arguments["content"] != "From ollama function" {
